...
// const newValues = data.flatMap(array => array.values);
...
// const newArray = people.some(people => people.age <= 20);
// console.log(newArray);

// const getNewArray = people => people.some(people => people.age <= 20);
...
// const everyNumbers = numbers.every(number => number % 2 === 0);
...
class Client {
 ...
 const ex1 = new Client("email@email.com", "qerfc1123")
console.log(ex1.login)
ex1.login = "defgyfu13225";
console.log(ex1.login)
 ...
 //  13) Наслідування у класах!
  ...
  // Крім того, клас `Employee` має мати метод `getEmployeeDetails()`, який повертає об'єкт 
  // з зарплатою співробітника та відділом, в якому він працює.
